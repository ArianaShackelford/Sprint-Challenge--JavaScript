...
console.log(`T-rex's weight:`,trex.weight);

// What was the diet of a velociraptor?
console.log(`Velociraptor's diet:`,veloci.diet);

// How long was a stegosaurus?
console.log(`Stegosaurus' length:`,steg.length);

// What time period did tyrannosaurus live in?
console.log(`T-rex's period:`,trex.period);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
trex.roar = () =>{return `RAWERSRARARWERSARARARRRR!`}

console.log(`T-rex says:`,trex.roar());
